...
class TestColumnInfo:
    def test_fastdataframe_default_values(self) -> None:
        """Test that FastDataframe has correct default values."""
        metadata = ColumnInfo()
        assert metadata.is_unique is False

    def test_fastdataframe_custom_values(self) -> None:
    ...
    def test_fastdataframe_from_schema_invalid_version(self) -> None:
    ...
    def test_fastdataframe_from_schema_missing_properties(self) -> None:
